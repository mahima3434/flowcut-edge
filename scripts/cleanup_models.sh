#!/usr/bin/env bash
# ============================================================================
# Cleanup Vision Model - Deletes llava-hf/llava-v1.6-mistral-7b-hf
# Use this to free up disk space.
# ============================================================================
set -e

MODEL_ID="models--llava-hf--llava-v1.6-mistral-7b-hf"
BOLD="\033[1m"
GREEN="\033[32m"
RED="\033[31m"
NC="\033[0m"

echo -e "${BOLD}Checking for LLaVA-NeXT model files...${NC}"
